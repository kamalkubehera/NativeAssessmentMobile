...
class CustomTableViewCell: UITableViewCell {
    ...
    var contact:DataModel? {
        didSet {
            ...
            if let title = contactItem.dateAndTime {
                titleLabel.text = " \(title) "
            }
            
            //TableView description text..
            if let temperture = contactItem.temperture, let humdity = contactItem.humdity{
                descriptionLabel.text = " Temperture: \(temperture) and Humdity: \(humdity)"
            }
        }
    }
